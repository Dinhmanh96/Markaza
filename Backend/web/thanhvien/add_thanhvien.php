<?php
	...
	// $rows = mysql_fetch_array($query);
 	...
 	if(isset($_POST['submit'])){
			...
			$sqlKiemTra = "SELECT * FROM thanhvien WHERE username = '$username'";
			$queryKiemTra = mysql_query($sqlKiemTra);

			$totalRows = mysql_num_rows($queryKiemTra);
			...
			if($totalRows > 0){
				...
				$sql = "INSERT INTO thanhvien(username,password,ten_thanhvien,email_thanhvien,sdt_thanhvien,dc_thanhvien)VALUES('$username','$password','$ten_thanhvien','$email_thanhvien','$sdt_thanhvien','$dc_thanhvien')";
				$query = mysql_query($sql);
	...
	<div class="container">
		...
		<form enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="ten_thanhvien" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Email</label>
				<input type="text" name="email_thanhvien" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Phone</label>
				<input type="text" name="sdt_thanhvien" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Địa chỉ</label>
				<input type="text" name="dc_thanhvien" class="form-control">
			</div>
