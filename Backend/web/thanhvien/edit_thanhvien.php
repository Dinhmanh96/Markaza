<?php
	...
	$rows = mysql_fetch_array($query);
 	...
 	if(isset($_POST['submit'])){
		...
		$sql = "UPDATE thanhvien SET username = '$username', password = '$password', ten_thanhvien ='$ten_thanhvien', email_thanhvien ='$email_thanhvien' , sdt_thanhvien = '$sdt_thanhvien', dc_thanhvien = '$dc_thanhvien', quyen_thanhvien = '$quyen_thanhvien' WHERE id_thanhvien = '$id'";
		$query = mysql_query($sql);
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../Frontend/css/quantri.css">
	...
	<div class="container">
		...
		<div class="row head">
			<div class="col-xs-2 col-sm-2 col-md-2">
				<div><a href="#"><img src="../Frontend/image/logo_final.png" class="logo"></a></div>
			</div>
		...
		<form enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="ten_thanhvien" value="<?php echo $rows['ten_thanhvien'];?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Email</label>
				<input type="text" name="email_thanhvien" value="<?php echo $rows['email_thanhvien'];?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Phone</label>
				<input type="text" name="sdt_thanhvien" value="<?php echo $rows['sdt_thanhvien'];?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Địa chỉ</label>
				<input type="text" name="dc_thanhvien" value="<?php echo $rows['dc_thanhvien'];?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Phân quyền</label>
				<input type="text" name="quyen_thanhvien" value="<?php echo $rows['quyen_thanhvien'];?>" class="form-control">
			</div>
		...
		<div class="row footer">
			...
			<div class="col-xs-12 col-sm-12 col-md-3">
				...
				<img src="../Frontend/image/logo_card1.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px;">
				<img src="../Frontend/image/logo_card2.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px">
				<img src="../Frontend/image/logo_card3.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px;">
				<img src="../Frontend/image/logo_card4.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px;">
				<img src="../Frontend/image/logo_card5.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px;">
				<img src="../Frontend/image/logo_card6.jpg" class="img-responsive" width="50px"; height="auto" style="float: left; margin: 5px;">
			</div>
