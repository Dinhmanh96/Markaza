<?php
	$numbertv = mysql_num_rows($querytv);
	if($numbertv!=0){
	?>
	<center>
	...
	<table class="table table-hover">
			...
			<tbody>
			<?php while ($rows = mysql_fetch_array($querytv)) {
			?>
				<tr>
					...
					<!-- <td style="text-align:center;">
						<a onclick="return confirm('Bạn có muốn xóa?');" href="sp.php?page_layout=xoa_thanhvien&id=<?php echo $rows['id_thanhvien']; ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a>
					</td> -->
				</tr>
			<?php
				}  
