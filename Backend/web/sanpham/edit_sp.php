<?php
	...
	move_uploaded_file($tmp_name, '../Frontend/image/Source/'.$anh_sp);

		$sql = "UPDATE sp SET id_dmt = '$id_dmt', id_dmn = '$id_dmn', ten_sp ='$ten_sp', gia_sp ='$gia_sp' , bh_sp = '$bh_sp', chitiet_sp = '$chitiet_sp', anh_sp = '$anh_sp' WHERE id_sp = '$id'";
		$query = mysql_query($sql);
