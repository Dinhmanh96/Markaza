<?php
	...
	$totalRowssp = mysql_num_rows($querysp);
	...
	$totalRowstv = mysql_num_rows($querytv);
	
 	
 	$sql1 = "SELECT * FROM orderlist";
	$query1 = mysql_query($sql1);

	$totalRows1 = mysql_num_rows(mysql_query("SELECT * FROM orderlist WHERE sdt LIKE '%$new_search_input%' OR code_order LIKE '%$new_search_input%' OR name_customer LIKE '%$new_search_input%'"));
