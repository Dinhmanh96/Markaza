<?php
	...
	$sqlview = "SELECT * FROM sp WHERE id_dmn = '$id_dmn' ORDER BY RAND() DESC LIMIT 15";
	
	$queryview  = mysql_query($sqlview);
?>
<div style="background-color: #00b3b3; height: 40px"><h5 style="color: #fff; padding-top: 13px; padding-left: 15px"><b>Sản phẩm tương tự bạn có thể xem</b></h5></div>

			<div id="myCarousel_sptuongtu" class="carousel slide" data-ride="carousel" data-interval="2500">
				...
				?>
				<a class="left carousel-control" href="#myCarousel_sptuongtu" role="button" data-slide="prev">
			      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
			      <span class="sr-only">Previous</span>
			    </a>
			    <a class="right carousel-control" href="#myCarousel_sptuongtu" role="button" data-slide="next">
