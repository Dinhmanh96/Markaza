<?php
	if(isset($_GET['id_dmt'])){
		$id_dm = $_GET['id_dmt'];
		$sqlview = "SELECT * FROM sp WHERE id_dmt = '$id_dm' ORDER BY view DESC LIMIT 15";
	}else{
		$id_dm = $_GET['id_dmn'];
		$sqlview = "SELECT * FROM sp WHERE id_dmn = '$id_dm' ORDER BY view DESC LIMIT 15";
	}
	
	$queryview  = mysql_query($sqlview);
?>
<div style="background-color: #00b3b3; height: 40px"><h5 style="color: #fff; padding-top: 13px; padding-left: 15px"><b>Top sản phẩm <?php echo $rs;?> xem nhiều</b></h5></div>

			<div id="myCarousel_topdmview" class="carousel slide" data-ride="carousel" data-interval="2500">
				...
				?>
				<a class="left carousel-control" href="#myCarousel_topdmview" role="button" data-slide="prev">
			      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
			      <span class="sr-only">Previous</span>
			    </a>
			    <a class="right carousel-control" href="#myCarousel_topdmview" role="button" data-slide="next">
