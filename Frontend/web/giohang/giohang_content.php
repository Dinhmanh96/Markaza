						...
						<form class="form-group" id="giohang" method="post">
							...
							while ($rows = mysql_fetch_array($query)) {
								...
								<div class="row">
									...
									<div class="col-xs-1 col-sm-1 col-md-1"><a href="../Frontend/web/giohang/xoahang.php?id_sp=<?php echo $rows['id_sp'] ?>"><button type="button" class="btn btn-primary btn-xs " >x</button></a></div>
								</div>
								<hr>
